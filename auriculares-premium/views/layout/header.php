					...
					<div class="row contenedor-logo">
						...
						<div class="col-md-3">
							<div class="header-logo" style="">
								<a href="/auriculares-premium/auriculares-premium" class="logo">
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						<li class="<?php if($pagina === "home"){ echo "active"; } ?>"><a href="/auriculares-premium/auriculares-premium">Home</a></li>
